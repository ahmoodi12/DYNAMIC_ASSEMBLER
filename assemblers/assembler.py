...
if __name__ == "__main__":
    ...
    output_path = args.output.resolve() if args.output else program_path.with_suffix(".bin")
    ...
    start = time.time()
    ut.Assembler().run(program_path, isa_path, output_path, binary_size, args.multi, args.debug)
